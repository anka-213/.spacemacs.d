...
(defun dotspacemacs/emacs-lisp/custom-bindings ()
...
(defun dotspacemacs/haskell/functions ()
  (defun reload-haskell-last-line () (interactive)
         "Reload the file and rerun the latest one."
           ...
           (haskell-interactive-mode-return)
           ;; (print haskell-interactive-previous-buffer)
           (sleep-for 3)
  ...
  (defun haskell-interactive-toggle-print-mode ()
    (interactive)
    "Select how output in the haskell REPL should be printed"
...
(defun dotspacemacs/haskell/custom-bindings ()
  (dolist (mode '(haskell-mode haskell-interaction-mode))
    (spacemacs/set-leader-keys-for-major-mode mode
      "l" 'haskell-process-load-file
      "," 'reload-haskell-last-line
      ))
...
you should place your code here."
  ...
  ;; (define-key evil-insert-state-map (kbd "m") 'self-insert-command)

  ;; Back/Forword buttons on mouse
  (define-key evil-normal-state-map (kbd "<mouse-4>") 'evil-jump-backward)
  (define-key evil-normal-state-map (kbd "<mouse-5>") 'evil-jump-forward)
  ...
  (setq helm-mode-fuzzy-match t) ;; Make helm searches less annoying
  ...
  ;; Agda
  (add-hook 'agda-mode-hook #'(define-key evil-normal-state-map (kbd "<mouse-2>") nil))
  ;; (define-key 'global (kbd "mouse-2") 'agda2-goto-definition-mouse)
  ;; Make jump to definition work. TODO: Only do this in agda mode
  ;; (define-key agda2-mode-map (kbd "<mouse-2>") 'agda2-goto-definition-mouse)
  ...
  ;; Workaround for "wrong number of arguments" error
  ...
  ;; TODO: https://oleksandrmanzyuk.wordpress.com/2011/10/23/a-persistent-command-history-in-emacs/
  ;; https://superuser.com/questions/67170/how-do-i-complete-file-paths-in-emacs#67224
  ...
  ;; https://github.com/SteveJobzniak/spacemaxed/commit/e39f8f5b4747ebf7cb9801fd9b8b13e435acb348
...
(custom-set-variables
 ...
 '(haskell-mode-hook
   (quote
    (haskell-indent-mode interactive-haskell-mode spacemacs/init-haskell-mode spacemacs//init-jump-handlers-haskell-mode)))
